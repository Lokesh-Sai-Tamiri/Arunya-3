...
This project includes a centralized theme configuration system for managing colors, typography, and design tokens.
...
- **Colors**: Primary, brown shades, milk/cream tones, accents, utilities, overlays
- **Typography**: Font families, sizes, line heights, letter spacing
- **Spacing**: Border widths, rotations, button sizes
- **Presets**: Pre-configured section-specific color combinations

### Documentation

For detailed theme documentation and usage examples, see:
- 📖 [Theme Guide](src/constants/THEME_GUIDE.md) - Complete theme system documentation
- 🎨 [Theme Configuration](src/constants/theme.js) - All available theme values
